...
public class DietNotificationSetArgument implements ArgumentType<String> {
  private static final Collection<String> EXAMPLES = Arrays.asList("negative", "positive");
  ...
  public static DietNotificationSetArgument set() {
    return new DietNotificationSetArgument();
  }
